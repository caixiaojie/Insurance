...
public class TempAliPayHelper {
     ...
     */
    public TempAliPayHelper(Context context,Handler handler,int handlerWhat,String subject, String body, String price,String PARTNER,String SELLER,String orderNumber,String alipayNotifyUrl,String RSA_PRIVATE){
        mContext=context;
