    ...
    private void initViews() {
      ...
      /*  wl.x = 0;*/
       /* DisplayMetrics dm = context.getResources().getDisplayMetrics();
        wl.width = dm.widthPixels;//让dialog的宽占满屏幕的宽
        wl.gravity = Gravity.BOTTOM;//出现在底部*/
    ...
    private class DialogAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
           ...
           //     viewholder.dialogItemButton.setTextColor(mFirstItemColor);
             ...
             //   viewholder.dialogItemButton.setTextColor(mFirstItemColor);
                viewholder.imageview.setImageResource(R.mipmap.hs_1);
                viewholder.dialogItemButton.setText("拍摄照片或视频");
             //   viewholder.dialogItemButton.setBackgroundResource(R.drawable.select_dialog_item_bg_top);
            } else if (position == mStrings.size() - 1) {
                viewholder.dialogItemButton.setText("从相册中选择");
              //  viewholder.dialogItemButton.setTextColor(mOtherItemColor);
                viewholder.imageview.setImageResource(R.mipmap.img);
