 ...
 * 认证信息 审核成功
 */
public class ActReviewSuccess extends BaseActivity {
    @Override
    protected void setContentView(Bundle savedInstanceState) {
        setContentView(R.layout.activity_act_review_success);
    }
    ...
    @Override
    @OnClick({R.id.toolbar_back,R.id.act_review_success_sure})
    protected void OnViewClicked(View v) {
        switch (v.getId()){
            case R.id.toolbar_back://返回键
                finish();
                break;
            case R.id.act_review_success_sure://确认
                break;
        }
    }
