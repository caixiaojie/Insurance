...
public class HistoryBillAdapter extends ListBaseAdapter<ResponseHistoryBillList.ResultBean.PageRecordBean> {
    private AlertDialog mDailog;
    private TextView frag_order_call_phone;
    private Activity activity;
    private LayoutInflater inflater;
    private Context mContext;
    private ResponseHistoryBillList.ResultBean.PageRecordBean item;
    private String phone;//贸易商电话
    public HistoryBillAdapter(Context context,Activity activity) {
        super(context);
    ...
    public void onBindItemHolder(SuperViewHolder holder, int position) {
        ...
        frag_home_recycler_detail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(mContext, ActWaybillDetail.class);
                intent.putExtra("swayId",item.getSwayId());
                intent.putExtra("swayBillCode",item.getSwayBillCode());
