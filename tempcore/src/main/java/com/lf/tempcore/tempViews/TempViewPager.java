 ...
 */
public class TempViewPager extends ViewGroup {
    ...
    public TempViewPager(Context context) {
        super(context);
        initViewPager();
    }

    public TempViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViewPager();
    }
     ...
     * of pages you will need to support or have lazy-temp_loading mechanisms in place
