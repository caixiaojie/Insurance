package com.lf.tempcore.tempBase.view;
...
public class ErrorLayout extends LinearLayout implements
    ...
    private void init() {
        View view = View.inflate(context, R.layout.refresh_view_error_layout, null);
    ...
    public void setErrorType(int state) {
        ...
        case NETWORK_ERROR:
            ...
            if (TempNetUtils.isNetConnected(getContext())) {
                tv.setText(R.string.error_view_load_error_click_to_refresh);
                img.setBackgroundResource(R.mipmap.none_loading_fail);
            } else {
