...
//        AppManager.getAppManager().addActivity(this);
    ...
    public void changeAppLanguage() {
        String sta = TempLoginConfig.sf_getIsChinese() ? "zh" : "en";//这是SharedPreferences工具类，用于保存设置，代码很简单，自己实现吧
        // 本地语言设置
    ...
    public void changeLanguage() {
                changeAppLanguage();
                TempActivity.this.recreate();//刷新界面
    }
...
//          Log.d("lf", "dianji");
    ...
    public void startActivityNoAn(Intent intent) {
        super.startActivity(intent);
    }

    public void finishNoAn() {
        super.finish();
    }
