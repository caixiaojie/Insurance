 ...
 * 描述:AdapterView适配器
 */
public abstract class CYAdapterViewAdapter<M> extends BaseAdapter {
    ...
    public CYAdapterViewAdapter(Context context, int itemLayoutId) {
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        final CYAdapterViewHolder viewHolder = CYAdapterViewHolder.dequeueReusableAdapterViewHolder(convertView, parent, mItemLayoutId);
