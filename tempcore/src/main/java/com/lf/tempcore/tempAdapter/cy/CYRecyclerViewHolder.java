 ...
 */
public class CYRecyclerViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
    ...
    public CYRecyclerViewHolder(RecyclerView recyclerView, View itemView, CYOnRVItemClickListener onRVItemClickListener, CYOnRVItemLongClickListener onRVItemLongClickListener) {
        super(itemView);
        ...
        mViewHolderHelper = new CYViewHolderHelper(mRecyclerView, this.itemView);
