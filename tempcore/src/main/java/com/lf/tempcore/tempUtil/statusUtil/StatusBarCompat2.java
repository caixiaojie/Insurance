...
public class StatusBarCompat2 {
    ...
    public static void setStatusBarColor(@NonNull Activity activity, ViewGroup viewGroup , @ColorInt int statusColor) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            StatusBarCompatLollipop.setStatusBarColor(activity,viewGroup, statusColor);
        } else if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            StatusBarCompatKitKat.setStatusBarColor(activity,viewGroup,statusColor);
        }
    }
